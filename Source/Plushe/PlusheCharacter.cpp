...
void APlusheCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void APlusheCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &APlusheCharacter::Move);
...
void APlusheCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void APlusheCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
